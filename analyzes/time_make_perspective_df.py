...
bins_t_s = ["2006-2012", "2013-2015", "2016", "2017", "2018"]import pickle
import numpy as np
import pandas as pd
from bootstrap import bootstrap
...
attributes = ['TOXICITY', 'SEVERE_TOXICITY', 'IDENTITY_ATTACK', 'INSULT', 'PROFANITY', 'THREAT', 'SEXUALLY_EXPLICIT',
              'FLIRTATION']
src_path = "./../data/sentiment/values_per_year/perspective/time/"
dst_path = "./../data/sentiment/dataframes/perspective_df/time/"
